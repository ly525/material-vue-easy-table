...
export default{
  ...
  render (h) {
    const template = <ul class="v-page-ul"></ul>;
    ...
    const size = settings.sizeMaps[this.size] || settings.sizeMapDefault;
    const sizeClass = size === settings.sizeMaps.large ? ' v-page--large' : (size === settings.sizeMaps.middle ? ' v-page--middle' : ' v-page--small');
  ...
  components: {
    ...
    Total: {
      render (h) {
        return (
                    <span class="v-page-total">&nbsp;Total&nbsp;{this.$parent.total}&nbsp;&nbsp;</span>
        );
      },
    },
    ...
    Jumper: {
      ...
      render (h) {
        return (
                    <span class="v-page-goto">&nbsp;Goto&nbsp;<input
